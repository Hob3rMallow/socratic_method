...
The 8,192-sample duration experiment and its locked morphology audit are
complete. Although an overlap-only calibration prefers 7,168 samples at the
censored lower threshold of 0.25, the independent anti-blob and human review
select the raw 8,192-sample checkpoint at threshold 0.45. This disagreement is
informative: the model is selected for retaining useful longitudinal structure
without refilling nearby wraps, not for maximizing one overlap scalar.
